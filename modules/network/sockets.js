    ...
    return {
        ...
        connect: (() => {
                    ...
                    if (body != null && socket.permissions > 0 && !global.arenaClosed) {
                        switch (m[0]) {
                            case 0: { // Testbed
                                ...
                                body.color = room.gameMode === "ffa" ? 12 : player.teamColor;
                ...
                function perspective(e, player, data) {
                    if (player.body != null) {
                        if (player.body.id === e.master.id) {
                            ...
                            if (room.gameMode === "ffa" && player.body.color !== 12) colorOverride = true;
            ...
            return (socket, req) => {
                ...
                socket.key = '';
                socket.id = id ++;
                socket.spawnEntity = Class.alphaDecagon;
                socket.player = {
                    camera: {},
                };
                socket.spectateEntity = null;
